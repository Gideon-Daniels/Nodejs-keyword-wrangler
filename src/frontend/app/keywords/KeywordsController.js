...
(function () {
  ...
  app.controller(
    "KeywordsController",
    function ($scope, RepositoryFactory, resolve, resolveEntity) {
      ...
      var KeywordsCategoriesRepostory = new RepositoryFactory({
...
load all keyword categories and categories from the API */
      JeywordCategoriesRepository.readAll().then(function (keywordCategories) {
...
ndtrack */
      $scope.keywordsGridOptions = {
        ...
        enableCellSelection: false, // breaks edit of clls with selcet element iftrue
        enableCellEdit: true,
