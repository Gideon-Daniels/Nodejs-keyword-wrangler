...
describe("The API", function () {
    ...
    async.series(
      ...
      function (err, results) {
        ...
        request.post(
          ...
          function (err, res, body) {
            if (err) throw (err, expect(res.statusCode).toBe(200));
            request.get(
              {
                url: "http://localhost:8081/api/keywords/",
                json: true,
  ...
  it("should create a new keyword when receiving a POST request at /api/keywords/:id/", function (done) {
    var expected = {
      _items: [{ id: 1, value: "Onion", categoryID: 1 }],
    };
